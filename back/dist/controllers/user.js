    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, user_1.getAllUsersService)()];
                case 1:
                    users = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    user = req.body;
                    return [4, (0, user_1.postUserRegisterService)(user)];
                case 1:
                    newUser = _a.sent();
...
function postUserLoginController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var credentials, user, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    credentials = req.body;
                    return [4, (0, user_1.postUserLoginService)(credentials)];
                case 1:
                    user = _a.sent();
                    res.status(201).json({ message: "User logged", user: user, token: true });
                    return [3, 3];
                case 2:
                    error_4 = _a.sent();
