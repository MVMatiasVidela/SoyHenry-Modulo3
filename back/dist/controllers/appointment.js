...
var appointment_1 = require("../services/appointment");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, appointment_1.getAllAppointmentsService)()];
                case 1:
                    appointment = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    id = req.params.id;
                    return [4, (0, appointment_1.getAppointmentByIdService)(Number(id))];
                case 1:
                    appointment = _a.sent();
                    res.status(200).json(appointment);
                    return [3, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, (0, appointment_1.postAppointmentService)(appointment)];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    id = req.params.id;
                    return [4, (0, appointment_1.putAppointmentService)(Number(id))];
                case 1:
                    appointment = _a.sent();
