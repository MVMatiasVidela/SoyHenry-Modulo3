...
function getAllServicesController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            services = (0, service_1.getAllServicesService)();
...
function getServiceByIdController(req, res) {
    ...
    var service = (0, service_1.getServiceByIdService)(id);
...
function postServiceController(req, res) {
    ...
    var result = (0, service_1.postServiceService)(serviceData);
...
function putServiceController(req, res) {
    var id = req.params.id;
    var serviceData = req.body;
    var result = (0, service_1.putServiceService)(id, serviceData);
...
function patchServiceController(req, res) {
    var id = req.params.id;
    var serviceData = req.body;
    var result = (0, service_1.patchServiceService)(id, serviceData);
    res.status(200).json({ message: result });
}
